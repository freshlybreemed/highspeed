...
export const Footer: React.FunctionComponent = () => (
  <footer className="f3-l f4-m f6 relative overflow-hidden pt5 pb2 mt5">
    <div className="pb3 w-50-ns w-100">
      <a href="/about" className="black no-underline fw6 f4 b db pv1 mv1 ">
        About
      </a>
      <a href="/events" className="black no-underline fw6 f4 b db pv1 mv1">
        Events
      </a>
      <a href="" className="black no-underline fw6 f4 b db pv1 mv1">
        Work With Us
      </a>
      <a href="" className="black no-underline fw6 f4 b db pv1 mv1">
        Help
    ...
    <form className="justify-center flex-nowrap items-center ">
      <label className=" dib">
        <input
          ...
          className="overflow-visible bg-black bn ph2 pv1 f5 fw6 white"
          placeholder="Email"
        />
      </label>
      <button
        type="submit"
        className="bn bg-transparent black pl3 ml1 fw6 dim f4"
      >
        Subscribe
      </button>
    </form>
